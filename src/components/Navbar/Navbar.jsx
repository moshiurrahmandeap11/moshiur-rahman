...
const menuItems = [
  { label: "Home", bg: "bg-orange-100" },
  { label: "My Self", bg: "bg-rose-100" },
  { label: "Experience", bg: "bg-yellow-100" },
  { label: "My Work", bg: "bg-green-100" },
  { label: "Reviews", bg: "bg-blue-100" },
  { label: "Certifications", bg: "bg-purple-100" },
  { label: "Contact", bg: "bg-pink-100" },
];
