...
const projects = [
  ...
  },
  {
    ...
    description: "Inspired by Fiverr, Miverr is a full-stack freelance service marketplace with real-time messaging, secure login (JWT & Firebase), service listings, gig ordering, and admin moderation panel. Optimized for UX with mobile responsiveness and animation.",
    tech: ["React", "Tailwind", "Node.js", "Express", "MongoDB", "JWT"],
    image: projectThumb1,
    ...
    <section className="bg-[#0f172a] text-white py-20 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        {projects.map((project, idx) => (
          <div
            key={project.id}
            className="flex  flex-col-reverse md:flex-row gap-8 items-center mb-20"
            data-aos="fade-up"
